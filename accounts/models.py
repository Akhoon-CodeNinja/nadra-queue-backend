...
class Office(models.Model):
    ...
    # ── Helper: latest camera-based crowd info ─────────────
    def latest_crowd_snapshot(self):
        """Returns the most recent CrowdSnapshot for this office, or None."""
        return self.crowd_snapshots.first()   # ordering = ['-captured_at']
...
# ==========================================================
# CROWD SNAPSHOT TABLE
# (LIVE CAMERA COUNTER → stores each detection snapshot)
# ==========================================================
class CrowdSnapshot(models.Model):
    ...
    people_count = models.PositiveIntegerField(
        help_text='Number of people detected by camera'
    )
